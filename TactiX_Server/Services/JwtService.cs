...
public interface IJwtService
{
    ...
    string GenerateAccessToken(TacticsUserModel user, string levelCode);
...
public class JwtService : IJwtService
{
    ...
    public string GenerateAccessToken(TacticsUserModel user, string levelCode)
    {
