...
public class PermissionService : IPermissionService
{
    ...
    public async Task<PermissionCheckResult> CanUpload(long userId, long fileSize)
    {
        ...
        return PermissionCheckResult.Succeeded();
    }
...
public class PermissionCheckResult
{
    ...
    public static PermissionCheckResult Succeeded() => new() { Success = true };
    public static PermissionCheckResult Failed(string message) => new() { Success = false, ErrorMessage = message };
}
